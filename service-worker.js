const CACHE='kingdom-impact-poster-background-v3';
const ASSETS=['./','./index.html','./manifest.json','./kingdom-impact-logo.jpg','./kingdom-impact-icon.png','./hero-background.jpg'];
