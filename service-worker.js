const CACHE='kingdom-impact-tech-retouched-v4';
const ASSETS=['./','./index.html','./manifest.json','./kingdom-impact-logo.jpg','./kingdom-impact-icon.png','./technology-background.png'];
